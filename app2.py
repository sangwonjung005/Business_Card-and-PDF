    ...
    try:
        ...
        for line in lines:
            ...
            # 회사명 찾기 (더 정교한 로직)
                ...
                # 주소나 다른 정보가 아닌지 확인
                exclude_words = ['번길', '동', '층', '센터', 'www', 'http', 'co.kr', 'com', 'kr', 're.kr']
            ...
            # 이름 찾기 (더 정교한 로직)
            elif 2 <= len(line) <= 15 and not any(c.isdigit() for c in line):
                # 특수문자나 주소 정보가 아닌지 확인
